...
|---|---|---|---|---|---|---|
| 1 | Login | Agent d'accueil | Open app → redirected to `/connexion` → enter identifiant + `HMIS_DEMO_SHARED_PASSWORD` → Se connecter | Authenticated; lands on hospital selection or dashboard | | |
