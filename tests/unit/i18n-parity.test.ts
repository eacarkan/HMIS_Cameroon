 ...
 */
const BILINGUAL_NAMESPACES = ["app", "auth", "topbar", "hospital", "dashboard", "nav", "roles", "emergency", "queue", "admission", "diagnostic", "draft", "gate7", "serviceType", "language", "configAdmin", "readinessAdmin", "central", "uat", "integration", "dhis2", "externalResult", "externalPayment", "insurance", "analytics", "patientMatch", "publicSite", "landing", "showcase", "demoAccess", "feedback"] as const;
