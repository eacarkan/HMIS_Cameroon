...
// Phase 4A — integration framework & external-system registry (hospital-scoped; mock-first; no live calls).
export {
  type CreateExternalSystemData,
  type CreateIntegrationJobData,
  listExternalSystems,
  findExternalSystemById,
  findExternalSystemByCode,
  createExternalSystem,
  updateExternalSystem,
  listExternalSystemConfigs,
...
// Phase 4B — DHIS2 mapping sets (hospital-scoped; aggregate-export config; placeholders only).
export {
  listDhis2MappingSets,
  findDhis2MappingSetById,
  findDhis2MappingSetByCode,
  createDhis2MappingSet,
  updateDhis2MappingSet,
  upsertDhis2Mapping,
} from "./dhis2-mapping";

// Phase 4C — external lab/radiology result import (hospital-scoped STAGING; never clinical automatically).
export {
  type CreateExternalResultImportData,
...
// Phase 4D — payment provider abstraction (hospital-scoped; mock only; integer FCFA).
export {
...
// Phase 4E — insurance / mutuelle foundation (hospital-scoped; manual only; billing-linked).
export {
  listPayers,
  findPayerById,
  findPayerByCode,
...
// Phase 4F — advanced reporting / analytics foundation (hospital-scoped; aggregate-only).
export {
...
// Phase 4G — patient-matching / MPI readiness (hospital-scoped; canonical pairs; guarded transitions).
export {
