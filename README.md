...
Seeded demo users (all share the password **`HMIS_DEMO_SHARED_PASSWORD`**):
...
Log in at `/connexion` with any account above and password `HMIS_DEMO_SHARED_PASSWORD` (Step 4). _All
