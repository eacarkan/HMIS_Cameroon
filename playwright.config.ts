...
// SYNTHETIC value for the e2e run: the global-setup reseed (subprocess), the app runtime,
// and the sign-in helper all use the same value. Never a real credential.
const DEMO_PW = process.env.HMIS_DEMO_SHARED_PASSWORD ?? "synthetic-demo-shared-pw";
process.env.HMIS_DEMO_SHARED_PASSWORD = DEMO_PW;
...
export default defineConfig({
  ...
  webServer: {
    ...
    env: {
      ...
      HMIS_DEMO_SHARED_PASSWORD: DEMO_PW,
    },
  },
});
